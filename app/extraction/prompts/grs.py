...
for the GRS Twenty CRM workspace.

Return strict JSON only. Do not wrap the JSON in markdown. The JSON object must
match this schema:
{
  "summary": "string",
  "disposition": "string, e.g. Updated, Callback, Not Interested, or no data",
  ...
  "pii_detected": true,
  "confidence": 0.0,
  "case_status": "string or no data",
  "documents_mentioned": "string or no data"
}
